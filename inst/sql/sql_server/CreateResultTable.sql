IF OBJECT_ID('@results_database_schema.cc_results', 'U') IS NOT NULL
DROP TABLE @results_database_schema.cc_results;

CREATE TABLE @results_database_schema.cc_results (
